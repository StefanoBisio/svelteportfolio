...
<a
    href={project.link}
    target="_blank"
    class="p-4 mb-11 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-accent1 text-center cursor-pointer group hover:border-white duration-200"
>
    <div
