    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi I'm <span class="text-violet-400">Stefano</span> Bisio
            ...
            <a
                href="#"
                target="_blank"
                class="blueShadow mx-auto lg:mx-0 lg:inline-block lg:mr-auto text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950"
            >
                <div
